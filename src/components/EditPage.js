...
const EditPage = ({ setAuth }) => {
	...
	async function fetchData() {
		// get the deck name and all its cards from the database at the ramandeepghotra-quiz.postgres.database.azure.com:3001/decks/:deck_id route
		try {
			const response = await fetch(
				`http://ramandeepghotra-quiz.postgres.database.azure.com:3001/profile/edit/${id}`,
				{
					method: "GET",
	...
	const updateCard = async (e) => {
		...
		try {
			...
			const response = await fetch(
				`http://ramandeepghotra-quiz.postgres.database.azure.com:3001/profile/edit/card`,
				{
					method: "PUT",
					headers: {
	...
	const deleteCard = async (e, card_id) => {
		...
		try {
			const body = { card_id };
			const response = await fetch(
				`http://ramandeepghotra-quiz.postgres.database.azure.com:3001/profile/delete/card`,
				{
					method: "DELETE",
					headers: {
						"Content-Type": "application/json",
